...
def clienti():
    ...
    with get_db() as db:
        ...
        for cliente in clienti_rows:
            ...
            # Calcola andamento (trend mensile)
            if totale_mese_prec > 0:
                andamento = round(((totale_mese_corrente - totale_mese_prec) / totale_mese_prec) * 100, 2)
            elif totale_mese_corrente > 0:
                andamento = 100.0
            else:
                andamento = 0.0
